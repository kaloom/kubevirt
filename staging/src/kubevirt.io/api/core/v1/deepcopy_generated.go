...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KactusNetwork) DeepCopyInto(out *KactusNetwork) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KactusNetwork.
func (in *KactusNetwork) DeepCopy() *KactusNetwork {
	if in == nil {
		return nil
	}
	out := new(KactusNetwork)
	in.DeepCopyInto(out)
	return out
}
